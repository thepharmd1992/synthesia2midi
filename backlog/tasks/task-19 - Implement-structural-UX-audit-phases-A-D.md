...
- [ ] #4 Settings uses fixed navigation and fixed global actions with one page-owned scroll viewport; short pages do not scroll and no active nested scroll areas remain.
- [ ] #5 Repeated Notes has a dedicated tool, Auto-Detect Expert shows one category at a time, and floating windows use the parent window screen.
