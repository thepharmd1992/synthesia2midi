...
- [ ] #2 The UI string manifest is byte-stable across Windows, macOS, and Linux path conventions.
- [ ] #3 Settings footer and Manual Fit numeric controls accommodate shipped locales and font scales on every runner.
