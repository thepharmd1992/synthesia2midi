...
class CalibrationGuideWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        definitions = [
            ...
            (self.tr("2. Find and check the keyboard overlays"), self.tr("Draw around the full keyboard, then check that the boxes line up with the keys."), self.tr("Find Keyboard"), KeyboardExample(boxed=True), self.find_keyboard_requested),
